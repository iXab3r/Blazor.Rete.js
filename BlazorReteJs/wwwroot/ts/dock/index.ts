 ...
 * @emits render
 */
export class AsyncDockPlugin<Schemes extends BaseSchemes> extends Scope<never, Area2DInherited<Schemes, never>> {
    nodes = new Map<() => Promise<Schemes['Node']>, { preset: Preset, element: HTMLElement }>()
     ...
     */
    async add(create: () => Promise<Schemes['Node']>, index?: number) {
     ...
     */
    remove(create: () => Promise<Schemes['Node']>) {
